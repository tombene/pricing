var ebay = {
	...
	getItems: function (searchTerm, displayItems) {
		...
		queryURL = 'https://svcs.ebay.com/services/search/FindingService/v1?OPERATION-NAME=findItemsByKeywords&SERVICE-VERSION=1.0.0&SECURITY-APPNAME=TylerSch-pricingC-PRD-edf6c4a56-cf9e2e63&RESPONSE-DATA-FORMAT=JSON&REST-PAYLOAD&keywords=' + searchTerm + '&paginationInput.entriesPerPage=1';
		$.ajax({
			url: queryURL,
			method: "GET"
		}).then(function (response) {
			var i = 0;
			ebay.currentItem.image = [];
